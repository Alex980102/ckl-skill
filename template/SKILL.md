...
license: Apache-2.0
compatibility: List binary / runtime / network requirements (e.g. `Requires foo CLI >= 1.0 on $PATH`, or for ckl-skill clones: `Requires ckl binary >= 0.5.3 on $PATH`). 1–500 characters.
metadata:
  version: 0.2.0
